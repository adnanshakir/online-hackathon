...
export function NewIncidentDialog({ open, onOpenChange }) {
  ...
  return (
    ...
    >
      <DialogContent className="max-w-2xl w-[95vw] sm:w-full p-0 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <DialogFooter className="p-6 border-t border-[var(--color-border)] flex flex-row items-center justify-end gap-2">
